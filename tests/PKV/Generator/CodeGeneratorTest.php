...
#[CoversClass(\KDuma\PKV\Generator\CodeGenerator::class)] final class CodeGeneratorTest extends TestCase
{
    ...
    public function testEmptyWhenNoVerifiedKeys(): void
    {
    ...
    public function testGeneratesWithoutUsernameAndWithBlacklist(): void
    {
    ...
    public function testGeneratesWithUsernameAndValidatorInstance(): void
    {
    ...
    public function testSkipsOutOfRangeVerifiedKeyIndices(): void
    {
        $def = $this->makeDefinition(
